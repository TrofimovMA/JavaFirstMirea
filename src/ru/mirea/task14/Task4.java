...
public class Task4
{
    Task4()
    {
        ArrayList<Integer> player1 = new ArrayList<Integer>(); // карты 1-го игрока
        ArrayList<Integer> player2 = new ArrayList<Integer>(); // карты 2-го игрока
        ArrayList<Integer> tQueue = new ArrayList<Integer>(); // рабочая переменная
        ...
        while(gWinner < 0)
        {
            ...
            // открытие карт
            card1 = player1.get(0); player1.remove(0);
            card2 = player2.get(0); player2.remove(0);
