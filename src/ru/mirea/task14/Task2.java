...
public class Task2
{
    Task2()
    {
        Queue<Integer> player1 = new LinkedList<Integer>(); // карты 1-го игрока
        Queue<Integer> player2 = new LinkedList<Integer>(); // карты 2-го игрока
        Queue<Integer> tQueue = new LinkedList<Integer>(); // рабочая переменная
